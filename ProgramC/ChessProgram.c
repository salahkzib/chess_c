...
EXPORT void Initializing(void) {
    ...
    WKing.Movement = KingPlayedMoves;
    WQueen.Movement = QueenPlayedMoves;
    WRook1.Movement = RookPlayedMoves;
    WRook2.Movement = RookPlayedMoves;
    WBishop1.Movement = BishopPlayedMoves;
    WBishop2.Movement = BishopPlayedMoves;
    WKnight1.Movement = KnightPlayedMoves;
    WKnight2.Movement = KnightPlayedMoves;
    WPawn1.Movement = PawnPlayedMoves;
    WPawn2.Movement = PawnPlayedMoves;
    WPawn3.Movement = PawnPlayedMoves;
    WPawn4.Movement = PawnPlayedMoves;
    WPawn5.Movement = PawnPlayedMoves;
    WPawn6.Movement = PawnPlayedMoves;
    WPawn7.Movement = PawnPlayedMoves;
    WPawn8.Movement = PawnPlayedMoves;
    ...
    BKing.Movement = KingPlayedMoves;
    BQueen.Movement = QueenPlayedMoves;
    BRook1.Movement = RookPlayedMoves;
    BRook2.Movement = RookPlayedMoves;
    BBishop1.Movement = BishopPlayedMoves;
    BBishop2.Movement = BishopPlayedMoves;
    BKnight1.Movement = KnightPlayedMoves;
    BKnight2.Movement = KnightPlayedMoves;
    BPawn1.Movement = PawnPlayedMoves;
    BPawn2.Movement = PawnPlayedMoves;
    BPawn3.Movement = PawnPlayedMoves;
    BPawn4.Movement = PawnPlayedMoves;
    BPawn5.Movement = PawnPlayedMoves;
    BPawn6.Movement = PawnPlayedMoves;
    BPawn7.Movement = PawnPlayedMoves;
    BPawn8.Movement = PawnPlayedMoves;
